    ...
    <div class="grid md:grid-cols-3 gap-5">
      ...
      <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden card-hover">
        <div class="aspect-[4/3] overflow-hidden bg-gray-100">
          <img src="https://www.genspark.ai/api/files/s/qKpB8gJ8" alt="三菱電機エコキュート設置完了後の様子" class="w-full h-full object-cover hover:scale-105 transition-transform duration-500" loading="lazy">
        </div>
        <div class="p-4">
      ...
      <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden card-hover">
        <div class="aspect-[4/3] overflow-hidden bg-gray-100">
          <img src="https://www.genspark.ai/api/files/s/hvtchYVO" alt="エコキュート入替工事の完成写真" class="w-full h-full object-cover hover:scale-105 transition-transform duration-500" loading="lazy">
        </div>
        <div class="p-4">
          <div class="flex items-center gap-2 mb-2">
