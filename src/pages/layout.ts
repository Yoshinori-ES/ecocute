    ...
    <div class="flex items-center justify-between px-4 py-2">
      ...
      <div class="hidden md:flex items-center gap-3">
        <a href="tel:05017201813" class="flex items-center gap-2 bg-orange-500 hover:bg-orange-600 text-white font-bold px-4 py-2 rounded-lg text-sm transition-colors">
          ...
          <div class="leading-tight">
            <div class="text-[10px]">時間外はAI受付</div>
    ...
    <div class="grid md:grid-cols-3 gap-8">
      ...
      <div>
        ...
        <ul class="space-y-2 text-sm">
          <li><i class="fas fa-phone-alt w-5 text-orange-400"></i>TEL: <a href="tel:05017201813" class="hover:text-orange-400">050-1720-1813</a><span class="text-xs text-gray-500 ml-1">（時間外AI受付）</span></li>
...
<head>
  ...
  <script type="application/ld+json">
  {
    ...
    "priceRange":"¥",
    "description":"静岡県袋井市のエコキュート専門店。交換・修理・新規導入はお任せください。時間外はAI電話受付でスムーズ。有資格者多数在籍。給湯省エネ2026事業（補助金）対応。"
  }
  </script>
