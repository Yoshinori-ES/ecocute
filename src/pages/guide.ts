...
const troublePages: TroublePage[] = [
  {
    ...
    metaDesc: 'エコキュートの故障サイン・原因・対処法を分かりやすく解説。お湯が出ない、エラーコード表示、水漏れなどの症状別ガイド。袋井市の専門店が修理・交換を丁寧に対応。時間外も受付対応。',
  ...
  },
  {
    ...
    metaDesc: 'エコキュートの修理なら袋井市の専門店イーエス・テック。修理料金の目安、対応の流れ、全メーカー対応。有資格者が丁寧に診断・修理。お見積り0円。時間外も受付対応。',
    heroIcon: 'fa-wrench',
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-5">
      ...
      <div class="space-y-4">
        <div class="flex items-start gap-3">
          ...
          <div><h3 class="font-bold text-sm">お電話・メールでご連絡</h3><p class="text-xs text-gray-600">時間外も受付対応。症状やエラーコードをお伝えください。</p></div>
        </div>
        <div class="flex items-start gap-3">
      ...
      <div class="overflow-x-auto">
        <table class="w-full text-sm border-collapse">
          ...
          <tbody>
            ...
            <tr class="bg-gray-50"><td class="border border-gray-200 px-4 py-3 font-bold">標準工事費</td><td class="border border-gray-200 px-4 py-3 text-center font-bold text-lg">9〜18万円</td><td class="border border-gray-200 px-4 py-3 text-xs text-gray-500">既設撤去・新設取付・配管接続</td></tr>
      ...
      <div class="space-y-4">
        ...
        <div class="border border-gray-200 rounded-xl overflow-hidden">
          ...
          <div class="p-4 text-sm text-gray-600">
            ...
            <ul class="space-y-1 ml-4 text-xs"><li>✅ <strong>プロの点検が必要</strong>です</li><li>✅ 時間外も受付対応 → <a href="tel:05017201813" class="text-orange-500 underline font-bold">050-1720-1813</a></li><li>✅ 修理or交換、最適な提案をいたします</li></ul>
          </div>
        </div>
      </div>
    </div>`
